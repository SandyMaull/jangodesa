...
<footer>
    <div class="container-fluid padding">
        <div class="row text-center">
            <div class="col-md-4">
                <img src="{{ asset('img/logo-bg.png') }}" style="height:50px;"> <span style="margin-left:1.5rem;font-size:1.3em;">Jango Desa</span>
                <hr class="light">
                <p>0800 0000 0001</p>
                <p><a href="mailto:hokusei.uts@gmail.com">lorem ipsum</a></p>
            ...
            <div class="col-md-4">
                ...
                <h5>Support</h5>
                <hr class="light">
                <p><a href="https://uts.ac.id/">Universitas Teknologi Sumbawa</a></p>
                <p><a href="https://kuronekosan.web.id">Kuroneko</a></p>
            </div>
            <div class="col-12">
                <hr class="light-100">
                <h5>&copy: Jango Desa 2020</h5>
            </div>
        </div>
    </div>
</footer>