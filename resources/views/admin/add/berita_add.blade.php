...
@section('title')
Jango Desa - Publikasi - Tambah Berita Baru
@endsection
...
@section('content')
    <form class="form-horizontal" method="POST" action="{{ url('/administrator/publikasi/berita/add_post') }}">
        @csrf
        <div class="card-body">
            <div class="form-group row">
                <label for="judul_berita_id" class="col-sm-2 col-form-label">Judul</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="judul" id="judul_berita_id" placeholder="Judul Berita">
                </div>
            </div>
            <div class="form-group row">
                <label for="konten_berita_id" class="col-sm-2 col-form-label">Konten Berita</label>
                <div class="col-sm-10">
                    {{-- <textarea class="textarea" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid rgb(221, 221, 221); padding: 10px; display: none;"></textarea> --}}
                    <div class="mb-3">
        ...
        <div class="card-footer">
            ...
            <button type="submit" class="btn btn-info float-right">Tambah Berita</button>
        </div>
        <!-- /.card-footer -->
    </form>
@endsection
